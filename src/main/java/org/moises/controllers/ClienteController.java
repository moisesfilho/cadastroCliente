...
public class ClienteController {
  ...
  @GET
  public List<ClienteDTO> get(@QueryParam("page") @DefaultValue("0") int pageNumber, @QueryParam("size") @DefaultValue("0") int pageSize) {
    return clienteService.listPaginated(pageNumber, pageSize);
  }
